...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~XRESzbqb#Vzwa7MPQNCmyxOtP3DUW0pj120tiQFcztgYLuFZfHNQ",
    ...
    STICKER_NAME: process.env.STICKER_NAME || "D@GM@",     // Sticker pack name
